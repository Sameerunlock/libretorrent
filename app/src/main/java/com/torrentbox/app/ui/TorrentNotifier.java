...
public class TorrentNotifier {
    public static final String FOREGROUND_NOTIFY_CHAN_ID = "com.torrentbox.app.FOREGROUND_NOTIFY_CHAN";
    public static final String DEFAULT_NOTIFY_CHAN_ID = "com.torrentbox.app.DEFAULT_NOTIFY_CHAN_ID";
    public static final String FINISH_NOTIFY_CHAN_ID = "com.torrentbox.app.FINISH_NOTIFY_CHAN_ID";
