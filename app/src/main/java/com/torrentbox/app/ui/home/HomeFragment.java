...
import static com.torrentbox.app.ui.utils.HiddenTorrentStore.getHiddenIds;
...
import com.torrentbox.app.MainActivity;
import com.torrentbox.app.R;
import com.torrentbox.app.core.filter.TorrentFilterCollection;
import com.torrentbox.app.core.model.TorrentInfoProvider;
import com.torrentbox.app.core.model.data.SessionStats;
import com.torrentbox.app.core.model.data.TorrentListState;
import com.torrentbox.app.core.model.data.entity.TagInfo;
import com.torrentbox.app.core.sorting.BaseSorting;
import com.torrentbox.app.core.sorting.TorrentSorting;
import com.torrentbox.app.core.sorting.TorrentSortingComparator;
import com.torrentbox.app.core.utils.Utils;
import com.torrentbox.app.core.utils.WindowInsetsSide;
import com.torrentbox.app.databinding.FragmentHomeBinding;
import com.torrentbox.app.databinding.HomeDrawerContentBinding;
import com.torrentbox.app.databinding.MainNavRailHeaderBinding;
import com.torrentbox.app.ui.NavBarFragment;
import com.torrentbox.app.ui.NavBarFragmentDirections;
import com.torrentbox.app.ui.detailtorrent.BlankFragmentDirections;
import com.torrentbox.app.ui.detailtorrent.TorrentDetailsFragmentArgs;
import com.torrentbox.app.ui.detailtorrent.TorrentDetailsFragmentDirections;
import com.torrentbox.app.ui.filemanager.FileManagerConfig;
import com.torrentbox.app.ui.filemanager.FileManagerFragment;
import com.torrentbox.app.ui.home.drawer.model.DrawerDateAddedFilter;
import com.torrentbox.app.ui.home.drawer.model.DrawerSort;
import com.torrentbox.app.ui.home.drawer.model.DrawerSortDirection;
import com.torrentbox.app.ui.home.drawer.model.DrawerStatusFilter;
import com.torrentbox.app.ui.home.drawer.model.DrawerTagFilter;
import com.torrentbox.app.ui.home.model.TorrentListItemState;
import com.torrentbox.app.ui.tag.TorrentTagChip;
...
//###########################################################
// ================= PASSWORD PREF =================
private static final String PREF_HIDDEN_PASSWORD = "hidden_password_pref";
    private static final String KEY_HIDDEN_PASSWORD = "hidden_password";

    // 👇 YAHI paste karo
    private void savePassword(String password) {
        requireContext()
                .getSharedPreferences(PREF_HIDDEN_PASSWORD, Context.MODE_PRIVATE)
                .edit()
                .putString(KEY_HIDDEN_PASSWORD, hash(password))
                .apply();
    }
    ...
    private boolean verifyPassword(String entered) {
        String saved = requireContext()
                .getSharedPreferences(PREF_HIDDEN_PASSWORD, Context.MODE_PRIVATE)
                .getString(KEY_HIDDEN_PASSWORD, null);

        return saved != null && saved.equals(hash(entered));
    }

    private boolean isPasswordSet() {
        return requireContext()
                .getSharedPreferences(PREF_HIDDEN_PASSWORD, Context.MODE_PRIVATE)
                .contains(KEY_HIDDEN_PASSWORD);
    }

    // 👇 helper (same class ke andar)
    ...
    private void showFingerprintDialog() {
                ...
                new BiometricPrompt(
                        ...
                        new BiometricPrompt.AuthenticationCallback() {
                            ...
                            public void onAuthenticationSucceeded(
                                ...
                                // 🔓 Unlock
                                HiddenTorrentStore.unlock(requireContext());

                                NavHostFragment.findNavController(HomeFragment.this)
                                        .navigate(R.id.action_home_to_hidden);
                            }
                            ...
                            public void onAuthenticationError(
                                ...
                                // ❌ fingerprint cancel / error → password
                                showHiddenPasswordDialog();
                            }
                        }
                );
        ...
        BiometricPrompt.PromptInfo promptInfo =
                new BiometricPrompt.PromptInfo.Builder()
                        .setTitle("Unlock Hidden Torrents")
    ...
    //##################################################
// ================= HIDDEN TORRENTS PREF =================
    private static final String PREF_HIDDEN_TORRENTS = "hidden_torrents_pref";
...
//################################################################################################
    ...
    public void onListPaneViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        binding.searchBar.setOnLongClickListener(v -> {
            if (selectionTracker != null && selectionTracker.hasSelection()) {
                selectionTracker.clearSelection();
                finishContextualMode();
            }

            showHiddenUnlock();   // 👈 CHANGE
            return true;
        });
    ...
    private void showHiddenPasswordDialog() {

        Context context = requireContext();

        // 🔹 Material input layout
        TextInputLayout inputLayout = new TextInputLayout(context);
        inputLayout.setHint(isPasswordSet()
                ? "Enter password"
                : "Set admin password");

        TextInputEditText passwordInput = new TextInputEditText(context);
        ...
        MaterialAlertDialogBuilder builder =
                new MaterialAlertDialogBuilder(context)
                        .setIcon(R.drawable.ic_lock_24px)
                        .setTitle("Restricted Area")
                        .setMessage(isPasswordSet()
                                ? "Enter password to continue"
                                : "Create password for hidden area")
                        .setView(inputLayout)
        ...
        dialog.setOnShowListener(d -> {
            ...
            ok.setOnClickListener(v -> {
                ...
                if (entered.length() < 4) {
                    inputLayout.setError("Minimum 4 characters");
                    return;
                }
                ...
                } else if (!verifyPassword(entered)) {
                    inputLayout.setError("Wrong password");
                    return;
                }

                // 🔓 Unlock
                HiddenTorrentStore.unlock(context);
...
// 👈 YAHI CLASS END HAI
                ...
                .flatMapSingle((state) -> {
                    if (state instanceof TorrentListState.Initial) {
                        ...
                        return Flowable.fromIterable(loaded.list())
                                ...
                                .filter(info ->
                                        !HiddenTorrentStore.isHidden(requireContext(), info.torrentId)
                                )
    ...
    private Disposable getAllTorrentsSingle() {
        return viewModel.getAllTorrentsInfoSingle()
                ...
                .subscribe(
                        ...
                        (Throwable t) -> Log.e(
                                TAG,
                                "Getting torrent info list error: "
                                        + Log.getStackTraceString(t)
                        )
                );
    }
    ...
    private void handleHideAction() {
        if (!isPasswordSet()) {
            showCreatePasswordThenHide();
        } else {
            showVerifyPasswordThenHide();
        }
    }

    private void showCreatePasswordThenHide() {

        Context context = requireContext();
        EditText passInput = new EditText(context);
        passInput.setHint("Set admin password");
        passInput.setInputType(InputType.TYPE_CLASS_TEXT | InputType.TYPE_TEXT_VARIATION_PASSWORD);

        AlertDialog dialog = new AlertDialog.Builder(context)
                .setTitle("Create Password")
                .setMessage("Set password to hide files")
                .setView(passInput)
        ...
        dialog.setOnShowListener(d -> {
            ...
            btn.setOnClickListener(v -> {
                ...
                if (pass.length() < 4) {
                    passInput.setError("Minimum 4 characters");
                    return;
                }

                savePassword(pass);
                dialog.dismiss();
                hideSelectedTorrents();
            });
        });
    ...
    private void showVerifyPasswordThenHide() {
        ...
        dialog.setOnShowListener(d -> {
            ...
            btn.setOnClickListener(v -> {
                ...
                if (!verifyPassword(pass)) {
                    passInput.setError("Wrong password");
                    return;
                }
    ...
    private void hideSelectedTorrents() {

        Set<String> hiddenIds =
                getHiddenIds(requireContext());

        MutableSelection<TorrentListItem> selections = new MutableSelection<>();

        selectionTracker.copySelection(selections);

        for (TorrentListItem item : selections) {
            hiddenIds.add(item.torrentId);
        }

        HiddenTorrentStore.saveHiddenIds(requireContext(), hiddenIds);
    ...
    boolean onContextualMenuItemClickListener(MenuItem item) {
        ...
        } else if (itemId == R.id.hide_torrent_menu) {
            handleHideAction();
            return true;
